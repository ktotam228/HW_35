...
public class PrimeNumberCheckerTest implements ITest{
        String csvFile = "/Users/val/workspace/HW_35/src/test/java/core/primes.csv";  //path to prime.csv 
	...
	private void assertThat(boolean validate, Object equalTo) {
		
	}
	private Object equalTo(boolean parseBoolean) {
		return null;
	}
}
